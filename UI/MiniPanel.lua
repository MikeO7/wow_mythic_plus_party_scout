...
function MiniPanel:OnLoad()
    ...
    self.Sorting.Expression:SetScript("OnEnterPressed", function(self) self:ClearFocus() end)
    self.Sorting.Expression:SetScript("OnEscapePressed", function(self) self:ClearFocus() end)
    self.Sorting.Expression:HookScript("OnHide", function(self) self:ClearFocus() end)
