...
function PGF.UI_SetupMinMaxField(panel, field, keyword, size)
    ...
    -- hide
    field.Min:SetScript("OnHide", function(element)
        element:ClearFocus()
    end)
    field.Max:SetScript("OnHide", function(element)
        element:ClearFocus()
    end)
...
function PGF.UI_SetupAdvancedExpression(panel)
    ...
    panel.Advanced.Expression.EditBox:SetScript("OnHide", function(self) self:ClearFocus() end)
