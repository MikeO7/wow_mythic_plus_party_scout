...
L["dialog.members"]    = "|A:groupfinder-icon-friend:20:20|a |cffaaaaaaMembers|r"
L["dialog.tanks"]      = "|A:groupfinder-icon-role-large-tank:20:20|a |cff00ccffTanks|r"
L["dialog.heals"]      = "|A:groupfinder-icon-role-large-heal:20:20|a |cff00ff00Heals|r"
L["dialog.dps"]        = "|A:groupfinder-icon-role-large-dps:20:20|a |cffff4444DPS|r"
L["dialog.mprating"]   = "|TInterface\\Icons\\INV_Relics_Hourglass:20:20:0:0|t |cffffaa00M+ Rating|r"
...
L["dialog.filters.group"] = "|cffffcc00Group|r"
L["dialog.filters.dungeons"] = "|cffffcc00Dungeons|r"
L["dialog.filters.delves"] = "Delves"
L["dialog.filters.advanced"] = "Advanced Filter Expression"
L["dialog.partyfit"] = "|TInterface\\Icons\\INV_Misc_GroupNeedMore:20:20:0:0|t Party Fit"
L["dialog.partyfit.tooltip"] = "Only show groups that have enough available slots and the correct open roles to fit your current party."
L["dialog.notdeclined"] = "|TInterface\\Icons\\Spell_Holy_Absorption:20:20:0:0|t Not Declined"
L["dialog.notdeclined.tooltip"] = "Hide groups that have already declined your application."
L["dialog.blfit"] = "|TInterface\\Icons\\Spell_Nature_Bloodlust:20:20:0:0|t Bloodlust Fit"
L["dialog.blfit.tooltip"] = "If your group lacks Bloodlust, only show groups that already have it, or have room to invite someone who does."
L["dialog.brfit"] = "|TInterface\\Icons\\Spell_Nature_Reincarnation:20:20:0:0|t Battle Res Fit"
L["dialog.brfit.tooltip"] = "If your group lacks a Battle Rez, only show groups that already have one, or have room to invite someone who does."
L["dialog.matchingid"] = "|TInterface\\Icons\\INV_Misc_Key_04:20:20:0:0|t Matching ID"
L["dialog.matchingid.tooltip"] = "Only show groups that have the exact same instance lockout as yourself. Always shows all groups if you have no lockout."
L["dialog.needsbl"] = "|TInterface\\Icons\\Spell_Nature_Bloodlust:20:20:0:0|t Needs Bloodlust"
L["dialog.needsbl.tooltip"] = "Only show groups that currently do NOT have a Bloodlust class."
L["dialog.mprating.tooltip"] = "Filter groups based on the leader's Mythic+ Rating."
L["dialog.members.tooltip"] = "Filter groups based on the total number of players currently in the group."
L["dialog.tanks.tooltip"] = "Filter groups based on the current number of tanks."
L["dialog.heals.tooltip"] = "Filter groups based on the current number of healers."
L["dialog.dps.tooltip"] = "Filter groups based on the current number of DPS."
